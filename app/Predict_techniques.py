...
m = torch.load('./saved_weights_techniques_weight14_0609data.pt')
...
def Shap_text():
    ...
    for i in range(len(df)):
        ...
        with open('./app/templates/technical{}.html'.format(patient_format), 'w') as f:
            f.write(shap_text)
        directory[df['id'][i]] = '{}/shap/techniques?id={}&date={}'.format(ip_addr, df['id'][i], df['operation day'][i])
